   ...
   return (
     <div className="flex h-screen bg-gray-100 font-sans">
       ...
       <button
        ...
        className="md:hidden fixed top-4 left-4 z-50 bg-secondary text-white p-2 rounded-md shadow-lg transition-transform duration-200 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-100"
       >
         <svg
      ...
      >
         ...
         <div className="p-4 border-t border-gray-700">
           <button
            ...
            className="w-full bg-primary-600 hover:bg-primary-700 text-white font-bold py-2 px-4 rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-secondary"
           >
             Cerrar Sesion
           </button>
         </div>
